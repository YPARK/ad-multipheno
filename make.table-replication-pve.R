...
pdf('figure-replication/fig_replication_pve_stat_tot.pdf', width = 3, height = 7)
print(plt.pve.stat)
dev.off()
...
pdf('figure-replication/fig_replication_pve_stat_heatmap.pdf', width = 2.5, height = 7)
